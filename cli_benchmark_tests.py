...
AUDIO_FILE_PATH = "E:/Downloads/9.14-spring-2014/mit9_14s14_lec01_360p_16_9.wav"
GROUND_TRUTH_PATH = "E:/Downloads/9.14-spring-2014/dev_utterance_metadata.csv"
GT_TRANSCRIPT_FILE_PATH = "E:/Downloads/9.14-spring-2014/dev/lecture_01/transcript.txt"
GROUND_TRUTH_ROWS = 526 
RESULTS_CSV = "dev_debug_logs/comprehensive_benchmark_results.csv"
...
def main():
    ...
    for i, config in enumerate(TEST_CONFIGS):
        ...
        transcript_filename = f"dev_debug_logs/transcript_prediction_{safe_config_name}.txt"
        ...
        with open(RESULTS_CSV, mode='a', newline='') as file:
            ...
            writer.writerow([
                ...
                round(transcription_runtime, 2), round(p_mean, 4), round(r_mean, 4), round(f1_mean, 4)
            ])
